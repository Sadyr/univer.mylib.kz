...
from main_app.models.student import *
from main_app.models.teacher import *
from main_app.models.course import *
from  main_app.models.database import Session, Base, engine
...
def insert_main_data():
    ...
    cur = conn.cursor()
    with open('main_app/models/data.sql', 'r') as f:
        sql = f.read()
    cur.execute(sql)
    conn.commit()
    cur.close()
